...
<template>
  <div class="container h-100 d-flex flex-column pt-4">
    <div class="d-flex w-100 justify-content-center">
      <b-button v-if="canGoBack" variant="link" class="button__go-back text-primary" @click="redirect">
      ...
      <b-button v-if="isAuthenticated" variant="link" class="button__logout text-dark" @click="logout">
