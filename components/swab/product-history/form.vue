...
const { today, onlyDate, dateToShift, timePickerToTimeShift, timeStringToTimePicker } = useDate();
...
const fetch = async (id) => {
    ...
    try {
        ...
        form.facilityItem = { id: swabProductHistory.facilityItemId };
    } catch (e) {
        exception.value = e;
        error.value = true;
...
<template>
    <div class="swab-product-history__form">
        <b-col v-if="error" class="text-center">
            ...
            <p v-if="exception && isErrorIdNotFound(exception)" class="text-danger">ไม่พบข้อมูลที่ต้องการแก้ไข</p>
            ...
            <b-form v-else id="formSwabProductHistory" @submit="onFormSubmitted">
                        ...
                        <b-row class="px-3">
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="swabProductDate"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">วันที่
                                    </label>

                                    <date-picker id="swabProductDate" v-model.number="form.swabProductDate"
                                        class="form-control p-0 border-0" :disabled="submitting"
                                        :enable-time-picker="false" locale="th" auto-apply :clearable="false" />

                                    <b-form-invalid-feedback :state="isFormInvalid('swabProductDate', ['required'])">
                                        กรุณาเลือกวัน
                            ...
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="swabProductSwabedAt"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">เวลา
                                    </label>

                                    <date-picker id="swabProductSwabedAt" v-model.number="form.swabProductSwabedAt"
                            ...
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="shift"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">กะ</label>
                            ...
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="swabPeriod"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">ช่วงตรวจ
                                    </label>

                                    <div class="form-control p-0 border-0">
                                        <swab-period-select id="swabPeriod" v-model="form.swabPeriod"
                                            :disabled="submitting" />

                                        <b-form-invalid-feedback :state="isFormInvalid('swabPeriod', ['required'])">
                                            กรุณาเลือกช่วงตรวจ
                                        </b-form-invalid-feedback>
                                    </div>
                                </div>
                            ...
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="facility"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">เครื่อง
                                    </label>

                                    <div class="form-control p-0 border-0">
                                        <facility-select id="facility" v-model="form.facility" :disabled="submitting" />

                                        <b-form-invalid-feedback :state="isFormInvalid('facility', ['required'])">
                                            กรุณาเลือกเครื่อง
                                        </b-form-invalid-feedback>
                                    </div>
                                </div>
                            ...
                            <b-col md="4" class="mt-2">
                                <div class="input-group align-items-baseline">
                                    <label for="facilityItem"
                                        class="form-label min-w-75px d-block col-12 col-md-auto">ไลน์
                                    </label>

                                    <div class="form-control p-0 border-0">
                                        <facility-item-select id="facilityItem" v-model="form.facilityItem"
                ...
                <b-row class="mt-4">
                    <b-col>
                        ...
                        <swab-product-form v-model="form" :disabled="submitting"
                            :invalid-state="productFormInvalidState" class="px-3" />
                    </b-col>
                </b-row>
                ...
                <b-row class="mt-4">
                    <b-col>
                        ...
                        <b-row class="px-3">
                            <b-col>
                                <b-form-textarea id="swabProductNote" v-model="form.swabProductNote"
                                    :disabled="submitting" rows="3" max-rows="3" no-resize />
                            </b-col>
                        </b-row>
                    </b-col>
                </b-row>
                ...
                <b-row align-h="center" class="my-4">
                    <b-col cols="auto">
                        <b-button variant="outline-primary" size="lg" :disabled="submitting" @click="redirect">
                            ยกเลิก
                        </b-button>
                    </b-col>
